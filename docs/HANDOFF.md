...
## PATCH v1.6 — DARKCAMPUS X-COIN REWARD FEED, badge earns become shareable feed posts (July 24, Ennis)
...
## PATCH v1.7 — APPROVALS BACKLOG CLEARED + ALPHA DEADLINE EXTENDED, data-only patch (July 25, Ennis)
...
## PATCH v1.7 — PROJECT CHANNELS + X-BOT PROJECT FEED, MC Projects run live feeds inside Slack/Discord (July 24, Ennis)
...
## PATCH v1.8 — FEEDFORWARD SWEEP: roster re-heal, owed XC paid, new approvals (July 25, Ennis, data-only)
...
## PATCH v1.9 — CHECKPOINT SHOWS 0/0 TASKS, two-hop linkage fixed (July 25, Ennis)
...
## PATCH v1.10 — INACTIVE-HIERARCHY INHERITANCE + Copy task re-homed to Beta (July 25, Ennis-approved)
...
## PATCH v1.11 — iPHONE BRAND LOGIN (July 25, Ennis-approved)
...
## PATCH v1.12 — DARKCAMPUS CHANNEL MIRROR + X-BOT 5× DAILY CHECK-IN SYSTEM (July 27, Ennis-approved)
...
## PATCH v1.13 — MEMBER IDENTITY LINKS + CHANNEL PRIVACY + WIRED X-COIN ECONOMY, X-Bot now knows who's who (July 27, Ennis)
...
## PATCH v1.14 — HOST CONTROL SCOPE CHECKLIST, pflx-platform (July 25, Ennis-approved: full build + STRICT)
